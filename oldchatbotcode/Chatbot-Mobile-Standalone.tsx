/**
 * MOBILE CHATBOT COMPONENT - READY TO PASTE
 * 
 * A full-screen interactive AI chatbot for mobile devices
 * 
 * DEPENDENCIES:
 * npm install framer-motion
 * 
 * SETUP:
 * 1. Copy this file to your components folder
 * 2. Copy the API route (see Chatbot-API-Route.ts)
 * 3. Add your avatar assets to /public/mobile/ folder
 * 4. Import and use: <MobileChatbot />
 * 
 * REQUIRED ASSETS:
 * - /public/mobile/commo image.png (idle avatar)
 * - /public/mobile/typing1.mp4 (typing animation)
 * - /public/mobile/typing2.mp4 (typing animation)
 * - /public/mobile/body strech.mp4 (stretch animation)
 * - /public/mobile/yawing.mp4 (yawn animation)
 * - /public/mobile/speaker up.mp4 (speaking animation)
 */
