...
const personSchema = {
  ...
  image: {
    "@type": "ImageObject",
    url: `${BASE_URL}/abhay-google.jpg`,
    width: 800,
    height: 800,
  },
  jobTitle: "Freelance Full Stack Developer & Software Engineer",
  description:
    "Abhay Mallick is a Freelance Full Stack Developer, Software Engineer, and Computer Science Engineer based in Chandrapur, Maharashtra. He specializes in React, Next.js, Node.js, Android (Kotlin) development, and AI integrations. With 2+ years of experience and 50+ projects delivered, he builds CRMs, SaaS platforms, ecommerce sites, mobile apps, and enterprise software.",
  knowsAbout: [
    "React",
    "Next.js",
    "TypeScript",
