  ...
  return (
    ...
    >
      ...
      <div className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>
        <h2>Abhay Mallick Chandrapur &mdash; Career Timeline</h2>
        <p>
          Official career journey of Abhay Mallick, a software engineer and computer science professional. Mastered development at Kiran Academy and Inspire Engineering.
        </p>
      </div>
