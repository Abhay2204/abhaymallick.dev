  ...
  return (
    ...
    >
      ...
      <div className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>
        <h2>Abhay Mallick &mdash; Software Engineering &amp; Design Specializations</h2>
        <p>
          Learn what Abhay Mallick does exceptionally well: UI/UX design, full stack development, mobile apps development, and AI engineering services.
        </p>
      </div>
      {/* Background Grid */}
      <div
