          ...
          {activePhase === 1 && (
            <>
              ...
              <motion.div 
                ...
                className="absolute top-1/2 -translate-y-1/2 left-[5%] md:left-[8%] max-w-[260px] sm:max-w-[320px] z-20"
              >
              ...
              <motion.div 
                ...
                className="absolute top-1/2 -translate-y-1/2 right-[5%] md:right-[8%] flex flex-col items-end text-right pointer-events-none max-w-[90%] sm:max-w-lg z-20"
              >
                <motion.div variants={fadeUpVariants} className="mb-3 flex items-center gap-4">
                ...
                <motion.div variants={fadeUpVariants} className="flex flex-col items-end mb-8">
                  <span className="text-[64px] md:text-[90px] lg:text-[110px] font-sans font-black text-black tracking-tighter leading-[0.85]">
                    Abhay
                  </span>
                  <span className="text-[64px] md:text-[90px] lg:text-[110px] font-sans font-black text-blue-600 tracking-tighter leading-[0.85]">
                    Mallick.
                  </span>
                </motion.div>
                
                <motion.div variants={fadeUpVariants} className="bg-[#f5f5f5] px-6 md:px-8 py-4 border-r-4 border-blue-600 shadow-sm">
                  <TypingText text="FULL STACK DEVELOPER" className="text-black text-[11px] md:text-[13px] font-black tracking-[0.25em] uppercase" />
                </motion.div>
              </motion.div>
            </>
          )}
          ...
          {activePhase === 2 && (
            ...
            >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute top-1/2 -translate-y-1/2 left-[5%] md:left-[8%] max-w-[250px] sm:max-w-[320px]"
              >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute top-1/2 -translate-y-1/2 right-[5%] md:right-[8%] text-right max-w-[250px] sm:max-w-[320px]"
              >
                <motion.div variants={fadeUpVariants} className="border-r-4 border-black/10 pr-5">
                  <h4 className="text-[12px] uppercase tracking-[0.2em] font-bold text-black/50 mb-3">
          ...
          {activePhase === 3 && (
            ...
            >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute bottom-[8%] md:bottom-[10%] left-[5%] md:left-[8%] text-left max-w-[280px] sm:max-w-sm md:max-w-md"
              >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute bottom-[8%] md:bottom-[10%] right-[5%] md:right-[8%] text-right max-w-[280px] sm:max-w-xs md:max-w-sm"
              >
                <motion.div variants={fadeUpVariants} className="mb-4 md:mb-6 border-r-4 border-black/10 pr-4 md:pr-5">
                  <h3 className="text-[11px] md:text-[13px] font-sans font-bold text-black/60 tracking-[0.2em] uppercase">
                    <TypingText text="Core Expertise" />
                  </h3>
                </motion.div>
                <motion.p variants={fadeUpVariants} className="text-[16px] md:text-[20px] lg:text-[22px] font-sans font-medium text-black leading-snug tracking-tight text-black/80">
          ...
          {activePhase === 4 && (
            ...
            >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute top-[10%] left-[5%] md:left-[8%] max-w-[200px] sm:max-w-[300px] flex flex-col gap-10"
              >
              ...
              <motion.div 
                variants={containerVariants}
                initial="hidden" animate="visible" exit="exit"
                className="absolute top-[10%] right-[5%] md:right-[8%] text-right max-w-[200px] sm:max-w-[350px] flex flex-col items-end"
              >
                <motion.div variants={fadeUpVariants} className="border-t-2 border-black/10 pt-4 w-full">
                  <h4 className="text-[11px] uppercase tracking-[0.2em] font-bold text-blue-600 mb-4 text-right">Developed Solutions Focus</h4>
                  <p className="text-[20px] md:text-[28px] font-sans font-bold text-black leading-snug tracking-tight text-right">
