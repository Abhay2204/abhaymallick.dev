...
const Card = ({ index, project, progress, targetScale, total, onSelect }: CardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>
        <h2>Abhay Mallick Projects &mdash; Full Stack Portfolio</h2>
        <p>
          Showcase of custom developed applications, open-source projects, SaaS products, and mobile systems built by Abhay Mallick, freelance programmer.
        </p>
      </div>
      {/* Background Ambience */}
